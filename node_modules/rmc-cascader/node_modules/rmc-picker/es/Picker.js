...
var Picker = createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            'div',
            { className: classNames(pickerCls), ref: 'root', style: this.props.style },
            React.createElement('div', { className: prefixCls + '-mask', ref: 'mask' }),
            React.createElement('div', { className: prefixCls + '-indicator ' + indicatorClassName, ref: 'indicator', style: indicatorStyle }),
            React.createElement(
                'div',
